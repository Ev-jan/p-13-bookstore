    ...
    return (
        <Main>
            <LeftSection>
                ...
                {!isEditModeOn ? (
                    <UserCard userImage={<Image src="/profilePic.png" alt={"profile picture"} width={235} height={235} />} toggleForm={handleClick} />
                ) : (
                    <ProfileEditForm userImage={<Image src="/profilePic.png" alt={"profile picture"} width={235} height={235} />} toggleForm={handleClick} />
                )}
            </LeftSection>
            <RightSection>
                <h3>ABOUT ME</h3>
